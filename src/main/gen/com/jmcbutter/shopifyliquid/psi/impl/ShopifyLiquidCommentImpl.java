...
public class ShopifyLiquidCommentImpl extends ASTWrapperPsiElement implements ShopifyLiquidComment {

  public ShopifyLiquidCommentImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public PsiElement getCommentContent() {
    return findChildByType(COMMENT_CONTENT);
  }
