...
public class ShopifyLiquidOutputStatementImpl extends ShopifyLiquidStatementImpl implements ShopifyLiquidOutputStatement {

  public ShopifyLiquidOutputStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
